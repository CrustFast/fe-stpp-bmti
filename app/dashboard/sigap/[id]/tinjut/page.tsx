          ...
          {category === "permintaan-informasi" ? (
            ...
            <div className="space-y-4">
              <div className="grid gap-2">
                ...
                <Textarea
                  id="koreksi"
                  placeholder="Contoh: Mengajukan pelatihan khusus untuk pengajar"
                  value={koreksi}
              ...
              <div className="grid gap-2">
                ...
                <Textarea
                  id="analisis"
                  placeholder="Contoh: Pengajar tidak menguasai materi"
              ...
              <div className="grid gap-2">
                ...
                <Textarea
                  id="tindakan"
                  placeholder="Contoh: Memberikan kesempatan bagi pengajar untuk mengevaluasi dan meningkatkan kompetensinya"

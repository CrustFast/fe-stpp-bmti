    ...
    <>
      ...
      >
        <div className="flex lg:flex-1">
          <Link href="/" className="flex items-center -m-1.5 p-1.5">
            ...
            <Image
              ...
              priority
            />
            <h1 className="ml-2 font-bold text-lg sm:text-xl">KONFES</h1>
          </Link>
        </div>
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          ...
          <Link
            href="#benturanKepentinganForm"
            onClick={(e) => smoothScrollTo(e, '#benturanKepentinganForm')}
            className="relative text-sm font-semibold hover:text-gray-200 transition-colors"
            onMouseEnter={(e) => handleHover(e, true)}
            onMouseLeave={(e) => handleHover(e, false)}
          >
      ...
      >
        <div className="px-6 space-y-7 text-white text-lg font-medium">
          ...
          <Link
            href="#benturanKepentinganForm"
            onClick={(e) => { smoothScrollTo(e, '#benturanKepentinganForm'); toggleMobile(); }}
            className="block mobile-link"
          >
            Formulir Aduan
          </Link>

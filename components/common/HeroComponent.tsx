...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative h-screen w-full flex items-center justify-center text-center text-white">
      ...
      <div className="max-w-2xl px-4 pt-10 z-10">
        <Image
          src="/img/logo-bmti.png"
          alt="Logo BMTI"
          width={120}
          height={120}
          className="mx-auto mb-10 hero-logo"
          priority
        />
        ...
        <a
          ...
          className="mt-9 inline-flex items-center rounded-full border border-gray-300 px-6 py-3 text-sm font-semibold text-gray-200 shadow-sm hover:bg-white hover:text-gray-900 transition-colors duration-300 hero-button cursor-pointer"
        >
